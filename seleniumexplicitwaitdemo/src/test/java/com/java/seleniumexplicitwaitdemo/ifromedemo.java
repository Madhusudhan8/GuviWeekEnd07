...
public class ifromedemo {
	...
	
	{
		...
		Thread.sleep(3000);
		WebElement element= driver.findElement(By.cssSelector("@frameborder"));
		Thread.sleep(3000);
		driver.switchTo().frame(element);
		Thread.sleep(3000);
		WebElement elementOne= driver.findElement(By.cssSelector("#oauth-iframe"));
		Thread.sleep(3000);
